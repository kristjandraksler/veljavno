...
const faqs = [
  ...
  {
    q: 'Ali deluje na mobitelu?',
    a: 'Da! Veljavno deluje na vseh napravah — računalniku, tablici in mobilnem telefonu. Dostopno je tudi kot mobilna aplikacija.',
  },
  {
    q: 'Kaj se zgodi po plačilu?',
    a: 'Takoj po plačilu dobite dostop do dashboarda kjer dodate svoje dokumente in nastavite opomnike. Vse skupaj traja manj kot 2 minuti.',
  },
  {
    q: 'Ali moram plačevati vsako leto?',
    a: 'Ne! Veljavno je enkratno plačilo — plačate enkrat in uporabljate za vedno. Brez naročnine, brez skritih stroškov.',
  },
];
...
export default function Home() {
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-background text-foreground">
      ...
      <section id="top" className="relative pt-36 md:pt-44">
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-5 pb-12 md:grid-cols-12 md:px-8 md:pb-16">
          <motion.div initial={{ opacity: 0, y: 26 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} className="relative z-10 md:col-span-9">
            ...
            {/* Social proof */}
            <div className="mt-6 inline-flex items-center gap-3 rounded-2xl border border-border bg-card px-5 py-3 shadow-sm">
              <div className="flex -space-x-2">
                {['M', 'A', 'T', 'J'].map((c, i) => (
                  <div key={i} className="w-7 h-7 rounded-full bg-primary flex items-center justify-center text-white text-xs font-bold border-2 border-background">{c}</div>
                ))}
              </div>
              <p className="text-sm text-muted-foreground"><span className="font-semibold text-foreground">47+ uporabnikov</span> že varuje svoje dokumente</p>
            </div>
      ...
      <section className="py-24 md:py-36">
        <div className="mx-auto max-w-7xl px-5 md:px-8">
          <div className="rounded-[2rem] bg-primary p-10 md:p-16 flex flex-col md:flex-row items-center justify-between gap-10">
            <div>
              <p className="mb-3 text-sm font-semibold uppercase tracking-[0.18em] text-blue-200">Mobilna aplikacija</p>
              <h2 className="font-display text-4xl font-bold tracking-[-0.04em] text-white md:text-5xl">Veljavno v žepu. 📱</h2>
              <p className="mt-4 text-lg text-blue-100 max-w-lg">Upravljajte dokumente kjerkoli — dodajte, urejajte in preverite status direktno iz telefona.</p>
              <div className="mt-8 flex flex-wrap gap-4">
                <div className="flex items-center gap-2 bg-white/10 rounded-full px-4 py-2">
                  <span className="text-white text-sm">✓ iOS in Android</span>
                </div>
                <div className="flex items-center gap-2 bg-white/10 rounded-full px-4 py-2">
                  <span className="text-white text-sm">✓ Sinhronizirano s spletom</span>
                </div>
                <div className="flex items-center gap-2 bg-white/10 rounded-full px-4 py-2">
                  <span className="text-white text-sm">✓ Brezplačno z vsakim paketom</span>
                </div>
              </div>
              <div className="mt-8 flex gap-4">
                <div className="bg-black text-white px-6 py-3 rounded-xl flex items-center gap-3 opacity-70 cursor-not-allowed">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.8-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z"/></svg>
                  <div>
                    <div className="text-[9px] opacity-70">Kmalu na</div>
                    <div className="text-sm font-semibold">App Store</div>
                  </div>
                </div>
                <div className="bg-black text-white px-6 py-3 rounded-xl flex items-center gap-3 opacity-70 cursor-not-allowed">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M3.18 23.76c.3.17.64.24.99.2l12.45-7.19-2.78-2.78-10.66 9.77zm-1.76-20.3C1.16 3.77 1 4.1 1 4.56v14.88c0 .46.16.79.42 1.1l.08.08 8.34-8.34v-.2L1.5 3.38l-.08.08zM20.49 10.34l-2.37-1.37-3.13 3.13 3.13 3.14 2.4-1.38c.68-.39.68-1.03-.03-1.52zM4.17.24L16.62 7.43l-2.78 2.78L3.18.44C3.49.27 3.87.07 4.17.24z"/></svg>
                  <div>
                    <div className="text-[9px] opacity-70">Kmalu na</div>
            ...
            <div className="flex-shrink-0">
              <div className="w-48 h-80 bg-white/10 rounded-[2rem] border border-white/20 flex items-center justify-center">
                <div className="text-center">
                  <div className="text-6xl mb-4">📱</div>
                  <p className="text-white/70 text-sm">Mobilna app</p>
                  <p className="text-white/50 text-xs mt-1">Kmalu</p>
                </div>
              </div>
            </div>
          </div>
